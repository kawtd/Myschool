...
class Student extends \My\schoolBundle\Entity\Student implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'My\\schoolBundle\\Entity\\Student' . "\0" . 'id', '' . "\0" . 'My\\schoolBundle\\Entity\\Student' . "\0" . 'nom', '' . "\0" . 'My\\schoolBundle\\Entity\\Student' . "\0" . 'prenom', '' . "\0" . 'My\\schoolBundle\\Entity\\Student' . "\0" . 'date', '' . "\0" . 'My\\schoolBundle\\Entity\\Student' . "\0" . 'lieu', '' . "\0" . 'My\\schoolBundle\\Entity\\Student' . "\0" . 'genre', '' . "\0" . 'My\\schoolBundle\\Entity\\Student' . "\0" . 'adresse', '' . "\0" . 'My\\schoolBundle\\Entity\\Student' . "\0" . 'nomTuteur', '' . "\0" . 'My\\schoolBundle\\Entity\\Student' . "\0" . 'profition', '' . "\0" . 'My\\schoolBundle\\Entity\\Student' . "\0" . 'tel', '' . "\0" . 'My\\schoolBundle\\Entity\\Student' . "\0" . 'email', '' . "\0" . 'My\\schoolBundle\\Entity\\Student' . "\0" . 'obs', '' . "\0" . 'My\\schoolBundle\\Entity\\Student' . "\0" . 'Classe');
        }
