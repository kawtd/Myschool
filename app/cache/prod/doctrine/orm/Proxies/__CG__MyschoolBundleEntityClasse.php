 ...
 */
class Classe extends \My\schoolBundle\Entity\Classe implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'My\\schoolBundle\\Entity\\Classe' . "\0" . 'id', '' . "\0" . 'My\\schoolBundle\\Entity\\Classe' . "\0" . 'libelle');
        }
