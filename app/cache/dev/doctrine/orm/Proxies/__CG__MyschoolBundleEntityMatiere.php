 ...
 */
class Matiere extends \My\schoolBundle\Entity\Matiere implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'My\\schoolBundle\\Entity\\Matiere' . "\0" . 'id', '' . "\0" . 'My\\schoolBundle\\Entity\\Matiere' . "\0" . 'libelle');
        }
